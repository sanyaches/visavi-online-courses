export default {
  ...
  index: {
    ...
    faq: {
      first: {
        question: 'Что мне делать после оплаты?',
        answer: 'Сразу после оплаты вы получаете доступ.'
      },
      second: {
        question: 'Когда будет открыт доступ к обучению?',
        answer: 'Конечно получите, сертификат получает ученик по прохождению всех материалов курса и сдаче отработок.'
      },
      third: {
        question: 'Будет ли обратная связь от Виктории?',
        answer: 'Да, конечно'
      },
      fourth: {
        question: 'Обязательно ли присылать отработки?',
        answer: `
          Отработки присылать не обязательно. Но для того, чтобы хорошо усвоить материал уроков,
          рекомендуется выполнять отработки. У вас в доступе будет обратная связь,
          где мы сможем разобрать все вопросы по вашей отработки, если они будут.
        `
      },
      fifth: {
        question: 'Получу ли я сертификат по прохождению курса?',
        answer: `
          Сертификат получат все! Он придёт вам на почту через месяц после приобретения обучения.
