<template>
  <div class="course-page">
    <b-button v-if="!isPurchased || isExpired" class="course-page__buy-button" @click="buyCourse">
      <div>
        {{ $t('lesson_course.buy_button') }}
        <br>
        {{ $t('lesson_course.buy_course_button') }}
      </div>
    </b-button>
            ...
            <div class="course-page__promo-text">
              ...
              <div class="course-page__benefits">
                ...
                <div class="course-page__benefit">
                  ...
                  <div class="course-page__benefit-text">
                    <span>{{ $t('lesson_course.access_months') }}</span>
                    <br>
                ...
                <div v-if="!course.forMySelf" class="course-page__benefit">
                  ...
                  <div class="course-page__benefit-text">
                    <span>{{ $t('lesson_course.give_certificate') }}</span>
                    <br>
                    <span>{{ $t('lesson_course.certificate') }}</span>
                  </div>
                </div>
              </div>
            ...
            <div class="course-page__promo-text">
              ...
              <div class="course-page__benefits">
                ...
                <div class="course-page__benefit">
                  <font-awesome-icon icon="fa-solid fa-key" class="course-page__benefit-icon" />
                  <div class="course-page__benefit-text">
                    <span>{{ $t('lesson_course.expired_at') }}</span>
                    <br>
    ...
    <b-container>
      ...
      <div id="about" class="course-page__description-title">
        <h2>
          {{ $t('lesson_course.description_title') }}
        </h2>
      </div>
        ...
        <div class="course-page__lessons-container">
          ...
          <div v-if="theoryLessons.length">
            <h3 class="course-page__category-title">
              {{ $t('lesson_course.category_theory') }}
            </h3>
            <ul class="course-page__lessons-list">
          ...
          <div v-if="practiceLessons.length">
            <h3 class="course-page__category-title">
              {{ $t('lesson_course.category_practice') }}
            </h3>
            <ul class="course-page__lessons-list">
          ...
          <div v-if="bonusLessons.length" class="mt-3">
            <h3 class="course-page__category-title">
              {{ $t('lesson_course.category_bonus') }}
            </h3>
            <ul class="course-page__lessons-list">
...
export default {
  ...
  head () {
    return {
      title: this.$t('lesson_course.seo.title', { title: this.course.title }),
      meta: [
        {
          hid: 'description',
          name: 'description',
        ...
        { name: 'keywords', content: this.$t('lesson_course.seo.keywords', { words: this.course.title?.toLowerCase() }) },
        {
          name: 'news_keywords',
          content: this.$t('lesson_course.seo.keywords', { words: this.course.title?.toLowerCase() })
        },
        {
          property: 'og:title',
          content: this.$t('lesson_course.seo.title', { title: this.course.title })
        },
        {
